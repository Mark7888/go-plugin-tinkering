...
// Shutdown performs cleanup when the instance is destroyed. This is a no-op for the sample plugin.
func (s *SamplePlugin) Shutdown() error { return nil }

func main() {
	plugin.Serve(&plugin.ServeConfig{
		HandshakeConfig: shared.Handshake,
		Plugins:         shared.NewFactoryPluginMap(func() shared.PluginBase { return &SamplePlugin{} }),
	})
}
